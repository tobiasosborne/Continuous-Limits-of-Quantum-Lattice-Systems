...
Given that we now have a hilbert space of fluctuations we focus on the subsystem describing the low-energy fluctuations given by
\begin{equation}
	\widehat{\mathcal{H}}_{k=\frac14} \otimes \widehat{\mathcal{H}}_{k=-\frac14}.
\end{equation}
Given such a hilbert space of fluctuations we now implement a version of the \emph{Wightman reconstruction procedure} to obtain a representation for the hamiltonian describing the low-energy large-scale dynamics of the tight-binding model. 
