...
The simplest nontrivial of local fermion models is the spin-less tight binding model in one dimension
\begin{equation}
	H = \sum_{j\in \mathbb{Z}} a_{j+1}^\dag a_j + \text{h.c.}
\end{equation}
The ground state of this model is a fermi sea and the low-energy large-scale physics is understood to be described by the massless Dirac field, a fact we'll establish here. 
