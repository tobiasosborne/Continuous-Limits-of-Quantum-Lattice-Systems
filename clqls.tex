...
\end{equation}
Two argue this we first suppose the sum is finite and induct on the maximum number $\max_{j} m_j$ of functions appearing inside the ket. We then exploit the multilinearity of the ket, i.e.,
\begin{equation}
