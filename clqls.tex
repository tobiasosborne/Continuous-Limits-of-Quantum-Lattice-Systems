...
%\begin{defn}
%Let $I\subset \mathbb{R}$ and $s\in[0,\infty)$. We write 
%\begin{equation}
%	[I]_s \equiv \{ x\in \mathbb{Z}\,|\, e^{-s}x \in I\},
%\end{equation}
%for the \emph{discretisation} (or \emph{quantisation}) of $U$ at \emph{scale} $s$. Note that $[I]_s= (e^s I) \cap \mathbb{Z}$.
%\end{defn}
